...
import {BlogListResponseDataItem, HomePageListResponseDataItem} from "@/types/REST/api/generated";
  ...
  return (
    <MainWrapper>
      <Stack sx={{width:"100%",alignItems:"center"}}>
        <Stack sx={{width: {md:"80%",xs:"100%"}, height: {md: "41vh", xs: "50vh"}, position: "relative",justifyContent:"center"}}>
          <HomeHero />
        </Stack>
      </Stack>
